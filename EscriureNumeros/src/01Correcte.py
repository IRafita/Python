"""
Aqui teniu un programa que ha sortit a partir de lluitar molt, pero sobretot d'haver estat lluitant
per un sumador. Realment no ha aparegut per aqui aquest programa, sino pel sumador jajaja
"""
